...
func ValidateCrimeCase(v *validator.Validator, entity *CrimeCase) {
	...
	v.Check(!entity.IncidentDate.IsZero(), "incident_date", "must be provided")
	v.Check(entity.IncidentDate.Before(time.Now()), "incident_date", "must not be in the future")
}
...
func (e *CrimeCaseEntity) Insert(entity *CrimeCase) (int64, error) {
	...
	args := []any{entity.Hero.HeroID, entity.Villain.VillainID, entity.Description, entity.IncidentDate}
